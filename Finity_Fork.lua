...
function finity.new(isdark, gprojectName, thinProject)
    ...
    self2.ChangeToggleKey = function(NewKey)
        ...
        finityData.UpConnection =
            finity.gs["UserInputService"].InputEnded:Connect(
            function(Input)
                    ...
                    elseif string.lower(kind) == "keybind" or string.lower(kind) == "bind" then
                        ...
                        cheat.button.MouseButton1Up:Connect(
                            function()
                                ...
                                connection =
                                    finity.gs["UserInputService"].InputBegan:Connect(
                                    function(Input)
                                        if
                                            Input.UserInputType.Name == "Keyboard" and
                                                Input.KeyCode ~= finityData.ToggleKey and
